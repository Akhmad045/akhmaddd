        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">spp</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                ...
                <div data-i18n="Form Validation">Pembayaran</div>
              </a>
            </li>
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">History Pembayaran</span></li>
            <li class="menu-item">
              <a href="{{ url('history/pembayaran') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-grid"></i>
