                ...
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST"    ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="nisn"
                            value="{{$data->nisn}}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="alamat" value="{{$data->alamat}}"
                                placeholder="Masukan Alamat" />
                        </div>
                        
                        <div class="mb-3">
                            <label for="email" class="form-label">No Telp</label>
                            <input type="number" class="form-control" id="email" name="no_telp" value="{{$data->no_telp}}"
                                placeholder="Masukan No Telp" />
                        </div>
                        
                        <div class="mb-3">
                            <label for="email" class="form-label">ID SPP</label>
                            <input type="number" class="form-control" id="email" name="id_spp" value="{{$data->id_spp}}"
